...
async function getCommitMessageUsingTagName(tagName) {
    ...
    console.log(
        `The commit for the tag is https://github.com/cloud-carbon-footprint/ccf-backstage-plugin/commit/${commitSha}`,
    )
...
async function getReleaseDescriptionFromCommitMessage(commitMessage) {
    ...
    console.log(
        `Identified the changeset Pull request - https://github.com/cloud-carbon-footprint/ccf-backstage-plugin/pull/${prNumber}`,
    )
